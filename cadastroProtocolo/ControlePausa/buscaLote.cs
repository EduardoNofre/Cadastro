...
{
    public partial class buscaLote : Form
    {
        public buscaLote()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSql = "select remessa,lote,participante,[Status] as [Status da Remessa] from (select nmvalorindice as Participante,a.iddocumento from tb_valor_indice a "
+"join tb_documento c on c.iddocumento = a.iddocumento where  a.idindice = 2 ) g "
+"inner join (select nmvalorindice as Lote,d.iddocumento,dscaixa as Remessa,nmstatus as Status from tb_valor_indice d "
...
+ "where nmvalorindice = '" + textBox1.Text.Replace(" ", "") + "' and d.idindice = 1) h "
